...
AInventory_Item_C__pf563933975::AInventory_Item_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AInventory_Item_C__pf563933975::StaticClass() == GetClass()))
	{
		AInventory_Item_C__pf563933975::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__Sphere__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AInventory_Item_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Sphere__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Sphere__pf->OverrideMaterials.Reserve(1);
	bpv__Sphere__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AInventory_Item_C__pf563933975::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__item_object__pf = nullptr;
}
void AInventory_Item_C__pf563933975::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void AInventory_Item_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void AInventory_Item_C__pf563933975::bpf__UserConstructionScript__pf()
{
}
void AInventory_Item_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
void AInventory_Item_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__AInventory_Item_C__pf563933975
{
	FRegisterHelper__AInventory_Item_C__pf563933975()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/VirtualRealityBP/Blueprints/Inventory_Item"), &AInventory_Item_C__pf563933975::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AInventory_Item_C__pf563933975 Instance;
};
FRegisterHelper__AInventory_Item_C__pf563933975 FRegisterHelper__AInventory_Item_C__pf563933975::Instance;
