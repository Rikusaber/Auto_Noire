...
ABP_LightStudio_C__pf1079297466::ABP_LightStudio_C__pf1079297466(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__SkyLight1__pf->LightGuid = FGuid(0xF865A11A, 0x4D60F2CE, 0xD0E049B4, 0xE4264E96);
...
void ABP_LightStudio_C__pf1079297466::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__22->LightGuid = FGuid(0xA41A3326, 0x4DB0EDA2, 0x43EE81B2, 0x2542AA4E);
	__Local__22->Intensity = 3.141593f;
	__Local__23->ShadowBias = 0.400000f;
	__Local__23->bAffectDynamicIndirectLighting = true;
	__Local__23->LightGuid = FGuid(0xD80C4C93, 0x49AAC1FF, 0x9C8B82BB, 0xEFE1DD3F);
	...
	__Local__28->LightGuid = FGuid(0xD80C4C93, 0x49AAC1FF, 0x9C8B82BB, 0xEFE1DD3F);
	...
	__Local__29->LightGuid = FGuid(0xA41A3326, 0x4DB0EDA2, 0x43EE81B2, 0x2542AA4E);
...
void ABP_LightStudio_C__pf1079297466::bpf__SunMobility__pf()
{
	...
	FTransform bpfv__Temp_struct_Variable2__pf{};
	...
	do
	{
		...
		case 2:
			{
				...
				bpfv__CallFunc_AddComponent_ReturnValue__pf = CastChecked<UDirectionalLightComponent>(AActor::AddComponent(FName(TEXT("NODE_AddDirectionalLightComponent-2")), false, bpfv__Temp_struct_Variable__pf, this), ECastCheckedType::NullAllowed);
			}
		case 3:
			{
		...
		case 4:
			{
				bpfv__Temp_struct_Variable2__pf = FTransform( FQuat(0.000000,-0.000000,0.000000,1.000000), FVector(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000) );
				bpfv__CallFunc_AddComponent_ReturnValue2__pf = CastChecked<UDirectionalLightComponent>(AActor::AddComponent(FName(TEXT("NODE_AddDirectionalLightComponent-3")), false, bpfv__Temp_struct_Variable2__pf, this), ECastCheckedType::NullAllowed);
			}
		case 5:
			{
...
void ABP_LightStudio_C__pf1079297466::bpf__AtmosphereDensity__pf()
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__Temp_struct_Variable2__pf = FTransform( FQuat(0.000000,-0.000000,0.000000,1.000000), FVector(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000) );
				bpfv__CallFunc_AddComponent_ReturnValue2__pf = CastChecked<UAtmosphericFogComponent>(AActor::AddComponent(FName(TEXT("NODE_AddAtmosphericFogComponent-3")), false, bpfv__Temp_struct_Variable2__pf, this), ECastCheckedType::NullAllowed);
			}
		case 3:
			{
		...
		case 5:
			{
				bpfv__Temp_struct_Variable__pf = FTransform( FQuat(0.000000,-0.000000,0.000000,1.000000), FVector(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000) );
				bpfv__CallFunc_AddComponent_ReturnValue__pf = CastChecked<UAtmosphericFogComponent>(AActor::AddComponent(FName(TEXT("NODE_AddAtmosphericFogComponent-2")), false, bpfv__Temp_struct_Variable__pf, this), ECastCheckedType::NullAllowed);
			}
		case 6:
			{
...
void ABP_LightStudio_C__pf1079297466::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	{
		{114, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Blueprints/Assets/Skybox.Skybox 
		{115, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_Master.M_LightStage_Skybox_Master 
		{116, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Blueprints/Assets/SM_Arrows.SM_Arrows 
		{117, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Blueprints/Assets/M_LightStage_Arrows.M_LightStage_Arrows 
		{118, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Game/StarterContent/Blueprints/Assets/SunlightColorLUT.SunlightColorLUT 
		{119, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveFloat /Game/StarterContent/Blueprints/Assets/FogBrightnessLUT.FogBrightnessLUT 
		{120, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  TextureCube /Game/StarterContent/HDRI/HDRI_Epic_Courtyard_Daylight.HDRI_Epic_Courtyard_Daylight 
		{121, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_Black.M_LightStage_Skybox_Black 
		{122, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_HDRI.M_LightStage_Skybox_HDRI 
	};
