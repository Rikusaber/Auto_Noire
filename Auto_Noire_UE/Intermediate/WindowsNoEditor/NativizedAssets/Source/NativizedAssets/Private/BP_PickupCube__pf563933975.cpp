...
ABP_PickupCube_C__pf563933975::ABP_PickupCube_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	__Local__0->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_PickupCube_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__sprite__pf = CastChecked<UPaperSprite>(CastChecked<UDynamicClass>(ABP_PickupCube_C__pf563933975::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bCanBeDamaged = true;
}
...
void ABP_PickupCube_C__pf563933975::bpf__UserConstructionScript__pf()
{
}
