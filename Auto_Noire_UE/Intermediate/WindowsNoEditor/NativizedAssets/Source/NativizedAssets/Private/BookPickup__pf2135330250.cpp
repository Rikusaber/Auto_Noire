...
#include "BookPickup__pf2135330250.h"
...
ABookPickup_C__pf2135330250::ABookPickup_C__pf2135330250(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABookPickup_C__pf2135330250::StaticClass() == GetClass()))
	{
		ABookPickup_C__pf2135330250::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__Scene__pf = CreateDefaultSubobject<USceneComponent>(TEXT("Scene"));
	bpv__Book__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Book"));
	...
	bpv__Book__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Book__pf->AttachToComponent(bpv__Scene__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Book__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABookPickup_C__pf2135330250::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Book__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Book__pf->OverrideMaterials.Reserve(1);
	bpv__Book__pf->OverrideMaterials.Add(nullptr);
	bpv__Book__pf->RelativeScale3D = FVector(0.101210, 0.127067, 0.035762);
	if(!bpv__Book__pf->IsTemplate())
	{
		bpv__Book__pf->BodyInstance.FixupData(bpv__Book__pf);
	}
	...
	bpv__Trigger__pf->RelativeScale3D = FVector(2.056605, 2.056605, 2.794900);
	...
	TEXT("Book"), /* Literal Text */
	TEXT("[730529F046667875509952BEDC2E1035]"), /* Namespace */
	TEXT("76CF26EF4DF6823CAA93AEB8F4C1B219") /* Key */
	);
	bpv__TextRender__pf->RelativeLocation = FVector(10.445794, 30.715492, 0.000000);
	bpv__TextRender__pf->RelativeRotation = FRotator(0.000000, -40.000183, 0.000000);
	if(!bpv__TextRender__pf->IsTemplate())
	{
		bpv__TextRender__pf->BodyInstance.FixupData(bpv__TextRender__pf);
	}
	bpv__inRange__pf = false;
	bpv__itemInfo__pf.bpv__ItemImage_8_54304FE24CB654420C227187E6651149__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(ABookPickup_C__pf2135330250::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	TEXT("Book"), /* Literal Text */
	TEXT("[730529F046667875509952BEDC2E1035]"), /* Namespace */
	TEXT("9186FBD54419CDD5B60C7DB46EE57C51") /* Key */
	);
	...
	TEXT("[730529F046667875509952BEDC2E1035]"), /* Namespace */
	TEXT("0617DF0D41615DD90B1CD6BBC818C3C7") /* Key */
	);
	bpv__PickupText_Widget__pf = nullptr;
	bpv__MyCharacter__pf = nullptr;
}
void ABookPickup_C__pf2135330250::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void ABookPickup_C__pf2135330250::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 16);
	return; // KCST_GotoReturn
}
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_5(int32 bpp__EntryPoint__pf)
{
...
void ABookPickup_C__pf2135330250::bpf__ExecuteUbergraph_BookPickup__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 15);
	return; // KCST_GotoReturn
}
void ABookPickup_C__pf2135330250::bpf__UseAction__pf()
{
	bpf__ExecuteUbergraph_BookPickup__pf_1(26);
}
void ABookPickup_C__pf2135330250::bpf__BndEvt__Trigger_K2Node_ComponentBoundEvent_4_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
...
void ABookPickup_C__pf2135330250::bpf__BndEvt__Trigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, /*out*/ FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BookPickup__pf_3(17);
}
void ABookPickup_C__pf2135330250::bpf__ExamineAction__pf()
{
	bpf__ExecuteUbergraph_BookPickup__pf_4(16);
}
void ABookPickup_C__pf2135330250::bpf__DropAction__pf(AActor* bpp__InActor__pf)
{
	b0l__K2Node_Event_InActor__pf = bpp__InActor__pf;
	bpf__ExecuteUbergraph_BookPickup__pf_6(15);
}
void ABookPickup_C__pf2135330250::bpf__PickupItem_Event__pf()
{
	bpf__ExecuteUbergraph_BookPickup__pf_5(8);
}
void ABookPickup_C__pf2135330250::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BookPickup__pf_0(25);
}
void ABookPickup_C__pf2135330250::bpf__UserConstructionScript__pf()
{
}
void ABookPickup_C__pf2135330250::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
void ABookPickup_C__pf2135330250::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ABookPickup_C__pf2135330250
{
	FRegisterHelper__ABookPickup_C__pf2135330250()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/BPs/BookPickup"), &ABookPickup_C__pf2135330250::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABookPickup_C__pf2135330250 Instance;
};
FRegisterHelper__ABookPickup_C__pf2135330250 FRegisterHelper__ABookPickup_C__pf2135330250::Instance;
