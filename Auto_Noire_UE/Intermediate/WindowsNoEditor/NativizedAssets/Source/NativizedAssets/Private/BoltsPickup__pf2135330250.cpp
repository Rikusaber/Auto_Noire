...
#include "BoltsPickup__pf2135330250.h"
...
ABoltsPickup_C__pf2135330250::ABoltsPickup_C__pf2135330250(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABoltsPickup_C__pf2135330250::StaticClass() == GetClass()))
	{
		ABoltsPickup_C__pf2135330250::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	TEXT("Bolts"), /* Literal Text */
	TEXT("[399E2DB24363EC9CDFD43EB18DDAD087]"), /* Namespace */
	TEXT("AC24CFE746A5726A74BA74A07D094038") /* Key */
	);
	bpv__TextRender__pf->RelativeLocation = FVector(-35.453094, 6.251213, 33.000000);
	...
	bpv__StaticMesh__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoltsPickup_C__pf2135330250::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->RelativeLocation = FVector(5.473626, -55.519199, 3.000000);
	bpv__StaticMesh__pf->RelativeRotation = FRotator(0.000000, 60.000175, 0.000000);
	bpv__StaticMesh__pf->RelativeScale3D = FVector(0.145079, 0.145079, 0.145079);
	...
	bpv__StaticMesh1__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoltsPickup_C__pf2135330250::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh1__pf->RelativeLocation = FVector(-25.703348, -37.519299, 3.000000);
	bpv__StaticMesh1__pf->RelativeRotation = FRotator(0.000000, 0.000016, 0.000000);
	bpv__StaticMesh1__pf->RelativeScale3D = FVector(0.145079, 0.145079, 0.145079);
	...
	bpv__StaticMesh2__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoltsPickup_C__pf2135330250::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh2__pf->RelativeLocation = FVector(15.564713, -23.171646, 3.000000);
	bpv__StaticMesh2__pf->RelativeRotation = FRotator(0.000000, 110.000290, 0.000000);
	bpv__StaticMesh2__pf->RelativeScale3D = FVector(0.145079, 0.145079, 0.145079);
	...
	bpv__StaticMesh3__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoltsPickup_C__pf2135330250::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh3__pf->RelativeLocation = FVector(-5.885943, -2.246317, 3.000000);
	bpv__StaticMesh3__pf->RelativeRotation = FRotator(0.000000, -50.000305, 0.000000);
	bpv__StaticMesh3__pf->RelativeScale3D = FVector(0.145079, 0.145079, 0.145079);
	...
	bpv__StaticMesh4__pf->AttachToComponent(bpv__Scene__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__StaticMesh4__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoltsPickup_C__pf2135330250::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh4__pf->RelativeLocation = FVector(-21.546291, 1.395289, 4.457808);
	bpv__StaticMesh4__pf->RelativeRotation = FRotator(-18.747223, -93.859070, -36.005157);
	bpv__StaticMesh4__pf->RelativeScale3D = FVector(0.145079, 0.145079, 0.145079);
	if(!bpv__StaticMesh4__pf->IsTemplate())
	{
		bpv__StaticMesh4__pf->BodyInstance.FixupData(bpv__StaticMesh4__pf);
	}
	bpv__inRange__pf = false;
	bpv__itemInfo__pf.bpv__ItemImage_8_54304FE24CB654420C227187E6651149__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(ABoltsPickup_C__pf2135330250::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	TEXT("Bolts"), /* Literal Text */
	TEXT("[399E2DB24363EC9CDFD43EB18DDAD087]"), /* Namespace */
	TEXT("0753BCC94491846BB775B2B06EC86041") /* Key */
	);
	...
	TEXT("[399E2DB24363EC9CDFD43EB18DDAD087]"), /* Namespace */
	TEXT("F82AAEB741C09FD3AAA11BB9B1DC0CF0") /* Key */
	);
	bpv__PickupText_Widget__pf = nullptr;
	bpv__MyCharacter__pf = nullptr;
}
void ABoltsPickup_C__pf2135330250::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void ABoltsPickup_C__pf2135330250::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 16);
	return; // KCST_GotoReturn
}
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_5(int32 bpp__EntryPoint__pf)
{
...
void ABoltsPickup_C__pf2135330250::bpf__ExecuteUbergraph_BoltsPickup__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 15);
	return; // KCST_GotoReturn
}
void ABoltsPickup_C__pf2135330250::bpf__UseAction__pf()
{
	bpf__ExecuteUbergraph_BoltsPickup__pf_1(26);
}
void ABoltsPickup_C__pf2135330250::bpf__BndEvt__Trigger_K2Node_ComponentBoundEvent_4_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_BoltsPickup__pf_2(21);
}
void ABoltsPickup_C__pf2135330250::bpf__BndEvt__Trigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, /*out*/ FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BoltsPickup__pf_3(17);
}
void ABoltsPickup_C__pf2135330250::bpf__ExamineAction__pf()
{
	bpf__ExecuteUbergraph_BoltsPickup__pf_4(16);
}
void ABoltsPickup_C__pf2135330250::bpf__DropAction__pf(AActor* bpp__InActor__pf)
{
	b0l__K2Node_Event_InActor__pf = bpp__InActor__pf;
	bpf__ExecuteUbergraph_BoltsPickup__pf_6(15);
}
void ABoltsPickup_C__pf2135330250::bpf__PickupItem_Event__pf()
{
	bpf__ExecuteUbergraph_BoltsPickup__pf_5(8);
}
void ABoltsPickup_C__pf2135330250::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BoltsPickup__pf_0(25);
}
void ABoltsPickup_C__pf2135330250::bpf__UserConstructionScript__pf()
{
}
void ABoltsPickup_C__pf2135330250::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{151, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/items/bolt.bolt 
...
void ABoltsPickup_C__pf2135330250::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ABoltsPickup_C__pf2135330250
{
	FRegisterHelper__ABoltsPickup_C__pf2135330250()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/BPs/BoltsPickup"), &ABoltsPickup_C__pf2135330250::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABoltsPickup_C__pf2135330250 Instance;
};
FRegisterHelper__ABoltsPickup_C__pf2135330250 FRegisterHelper__ABoltsPickup_C__pf2135330250::Instance;
