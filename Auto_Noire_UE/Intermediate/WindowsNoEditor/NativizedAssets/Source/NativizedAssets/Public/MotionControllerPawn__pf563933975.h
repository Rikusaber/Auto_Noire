...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Played Waves", Category="Default", OverrideNativeName="played_waves"))
	TArray<USoundWave*> bpv__played_waves__pf;
	...
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_Lighter_K2Node_InputActionEvent_10"))
	virtual void bpf__InpActEvt_Lighter_K2Node_InputActionEvent_10__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_Inventory_K2Node_InputActionEvent_11"))
	virtual void bpf__InpActEvt_Inventory_K2Node_InputActionEvent_11__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_TeleportRight_K2Node_InputActionEvent_12"))
	virtual void bpf__InpActEvt_TeleportRight_K2Node_InputActionEvent_12__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_TeleportRight_K2Node_InputActionEvent_13"))
	virtual void bpf__InpActEvt_TeleportRight_K2Node_InputActionEvent_13__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_TeleportLeft_K2Node_InputActionEvent_14"))
	virtual void bpf__InpActEvt_TeleportLeft_K2Node_InputActionEvent_14__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_TeleportLeft_K2Node_InputActionEvent_15"))
	virtual void bpf__InpActEvt_TeleportLeft_K2Node_InputActionEvent_15__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_GrabRight_K2Node_InputActionEvent_16"))
	virtual void bpf__InpActEvt_GrabRight_K2Node_InputActionEvent_16__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_GrabRight_K2Node_InputActionEvent_17"))
	virtual void bpf__InpActEvt_GrabRight_K2Node_InputActionEvent_17__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_GrabLeft_K2Node_InputActionEvent_18"))
	virtual void bpf__InpActEvt_GrabLeft_K2Node_InputActionEvent_18__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_GrabLeft_K2Node_InputActionEvent_19"))
	virtual void bpf__InpActEvt_GrabLeft_K2Node_InputActionEvent_19__pf(FKey bpp__Key__pf);
