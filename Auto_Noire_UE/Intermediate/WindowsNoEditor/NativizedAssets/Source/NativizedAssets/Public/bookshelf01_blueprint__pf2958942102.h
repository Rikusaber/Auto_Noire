...
#include "bookshelf01_blueprint__pf2958942102.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Furniture/bookshelf01_blueprint.bookshelf01_blueprint_C", OverrideNativeName="bookshelf01_blueprint_C"))
class Abookshelf01_blueprint_C__pf2958942102 : public AActor
{
public:
	GENERATED_BODY()
	...
	Abookshelf01_blueprint_C__pf2958942102(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
